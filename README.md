...
To build:
```
./fbt COMPACT=1 DEBUG=0 FORCE=1 updater_package
```
To flash:
```
...
**FoxFW** is an independently developed firmware platform for studying and experimenting with automotive and embedded systems. It supports academic research, security experimentation, and exploration of vehicle technologies in a responsible and ethical manner.  
